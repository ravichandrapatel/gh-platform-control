...
- [ ] Ruleset on each workload `main` with required check `guard-new-stacks`
- [ ] Admin bypass disabled (repo and org)
- [ ] Branch protection / ruleset blocks direct pushes to `main`
